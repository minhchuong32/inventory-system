...
public class SupplierFactory implements EntityFactory<Supplier, SupplierDTO> {
    ...
    public void applyCreditLimit(Supplier supplier) {
        SupplierClassificationStrategy strategy = classificationFactory.getStrategy(supplier.getSupplierType());
    ...
    public SupplierDTO toDTO(Supplier supplier) {
        ...
        return SupplierDTO.builder()
                ...
                .remainingCredit(strategy.getRemainingCredit(supplier))
