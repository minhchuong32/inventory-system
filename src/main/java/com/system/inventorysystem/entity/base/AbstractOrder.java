package com.system.inventorysystem.entity.base;


import com.system.inventorysystem.enums.OrderStatus;
import com.system.inventorysystem.enums.PaymentStatus;
...
import com.system.inventorysystem.exception.BusinessException;
@Getter
@Setter
@SuperBuilder
@NoArgsConstructor
...
public abstract class AbstractOrder extends BaseEntity {
     ...
     * Subclasses should call this after modifying details or discount.
     */
