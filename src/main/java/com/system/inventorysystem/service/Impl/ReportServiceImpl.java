...
public class ReportServiceImpl implements ReportService {
    ...
    public DashboardStatsDto getDashboardStats() {
        ...
        List<com.system.inventorysystem.entity.Product> lowStock = productRepository.findLowStockProducts();
        List<com.system.inventorysystem.entity.Product> outStock = productRepository.findOutOfStockProducts();
