...
public class GoogleLoginStrategy implements AuthStrategy {
    ...
    private final OauthVerifierFactory factory;

    public GoogleLoginStrategy(JwtUtil jwtUtil, UserService userService, OauthVerifierFactory factory) {
    ...
    public AuthResponse login(LoginRequest request) {
        ...
        OauthVerifier verifier = factory.getVerifier(request.getAuthType());
        UserInforFromProvider info = verifier.verify(idTokenString);
